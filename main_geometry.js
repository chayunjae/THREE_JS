...
const sphereMaterial = new THREE.MeshStandardMaterial({ color: 0x000055 });
...
const pointsMaterial = new THREE.PointsMaterial({ color: 0xcc00ff, size: 0.05 });
const point = new THREE.Points(sphereGeometry, pointsMaterial);
point.position.set(5, 1, 0);
scene.add(point);
